...
const yrt = 'food-app-bf864-default-rtdb.asia-southeast1'
...
async function displayCongratulations(){
    try {
        const response = await fetch(`https://${yrt}.firebasedatabase.app/food-app.json`);
        if (!response.ok) {
